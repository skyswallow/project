...
EDiaryEditor = {
    ...
    initView: function (sParentID) {
        ...
        for(key in _toolMenuInfo) {
            for(var key2 in _toolMenuInfo[key]) {
                ...
                if(key == "Family") {
                    key2 = parseInt(key2);
                    if(key2 == 0) {// head
                        _toolbarStr3 += "<div style='cursor: default; position: absolute; width: 163px; top: 32px; left: 78px; display: none;' id='EDiaryEditorFontFamilyItem'>\
        ...
        var _toolbarStr9 = "<div style='position: absolute; left: 483px; top: 41px; display: none;' id='EDiaryEditorRsave' title='�ָ���һ��δ�ɹ���������'><img src='images/editor/rsave.gif' csrc='/images/rsave.gif' bsrc='/images/rsave_over.gif' onmouseover='this.src=this.bsrc' onmouseout='this.src=this.csrc'></div>";
        this.addHTML($("EDiaryEditorToolBar"), _toolbarStr9);
        ...
        if(window._isIE) {
            ...
            setInterval(function () {
                ...
                if(_this.iframe.style.display != "none") {
                    if(_this.iframe.contentWindow.document.body.innerHTML.toLowerCase() == "<div>&nbsp;</div>") {
                    ...
                    if(_this.iframe.contentWindow.document.body.innerHTML.toLowerCase() == "<p>&nbsp;</p>"){
                        _this.iframe.contentWindow.document.body.innerHTML = "" ;
                        return;
                    } 
                    if(_this.iframe.contentWindow.document.body.innerHTML.toLowerCase() == "<p></p>"){
                    ...
                    if($("editor_body_textarea").value.toLowerCase() == "<p>&nbsp;</p>") {
                        _this.iframe.contentWindow.document.body.innerHTML = "" ;
                        return;
                    } 
                    if($("editor_body_textarea").value.toLowerCase() == "<p></p>") {
